({
	handleApplicationEvent : function(component, event, helper) {
        ...
        console.log("RecordMarkerController: ltng:SelectSobject - recordID = " + params.recordId);
        console.log("RecordMarkerController: ltng:SelectSobject - channel = " + params.channel);
