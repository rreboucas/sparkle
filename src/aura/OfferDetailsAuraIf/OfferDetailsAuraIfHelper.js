    ...
    createOfferAndNavigate : function(cmp) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                cmpEvent.setParams({"enteredSalary" : cmp.get("v.enteredSalary") });
                cmpEvent.setParams({"email" : lstRecs[0].candidateEmail });
                cmpEvent.setParams({"offerId" : cmp.get("v.offerId") });
                cmpEvent.setParams({"enteredBonus" : cmp.get("v.enteredBonus") });
                cmpEvent.setParams({"selectedTemplateId" : cmp.get("v.selectedTemplateId") });
